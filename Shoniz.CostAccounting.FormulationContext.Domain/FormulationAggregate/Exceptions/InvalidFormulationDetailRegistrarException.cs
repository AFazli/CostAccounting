...
{
    public class InvalidFormulationDetailRegistrarException : DomainException
    {
        public override string Message => FormulationException.InvalidFormulationDetailRegistrarException;
    }
}
