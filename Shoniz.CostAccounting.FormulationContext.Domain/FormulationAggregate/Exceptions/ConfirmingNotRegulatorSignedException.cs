...
{
    public class ConfirmingNotRegulatorSignedException : DomainException
    {
        public override string Message => FormulationException.ConfirmingNotRegulatorSignedException;
    }
}
