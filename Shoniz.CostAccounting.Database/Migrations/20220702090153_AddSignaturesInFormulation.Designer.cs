...
namespace Shoniz.CostAccounting.Database.Migrations
{
    ...
    [Migration("20220702090153_AddSignaturesInFormulation")]
    partial class AddSignaturesInFormulation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shoniz.CostAccounting.FormulationContext.Domain.FormulationAggregate.Formulation", b =>
                {
                    b.OwnsOne("Shoniz.CostAccounting.FormulationContext.Domain.Shared.ValueObjects.Signature.Signature", "Confirmer", b1 =>
                        {
                            ...
                            b1.HasKey("FormulationId");

                            b1.ToTable("Formulations", "FormulationContext");

                            b1.WithOwner()
                                .HasForeignKey("FormulationId");
                        });

                    b.OwnsOne("Shoniz.CostAccounting.FormulationContext.Domain.Shared.ValueObjects.Signature.Signature", "Regulator", b1 =>
                        {
                            b1.Property<Guid>("FormulationId")
                                .HasColumnType("UniqueIdentifier");
            ...
            modelBuilder.Entity("Shoniz.CostAccounting.FormulationContext.Domain.FormulationAggregate.FormulationDetail", b =>
                {
                    ...
                    b.OwnsOne("Shoniz.CostAccounting.FormulationContext.Domain.Shared.ValueObjects.Signature.Signature", "Registrar", b1 =>
                        {
                            b1.Property<Guid>("FormulationDetailId")
                                .HasColumnType("UniqueIdentifier");
